...
ALTER TABLE figurine ADD COLUMN image VARCHAR(255);

UPDATE figurine
SET image = '/images/aerith.png'
WHERE id = 1;

UPDATE figurine
SET image = '/images/barret.png'
WHERE id = 2;

UPDATE figurine
SET image = '/images/cloud-ac.png'
WHERE id = 3;

UPDATE figurine
SET image = '/images/nanaki.png'
WHERE id = 4;

UPDATE figurine
SET image = '/images/sephiroth.png'
WHERE id = 5;

UPDATE figurine
SET image = '/images/tifa.png'
WHERE id = 6;
